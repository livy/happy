...
export const zhHant: TranslationStructure = {
    ...
    projects: {
        noProjectsTitle: '還沒有專案',
        noProjectsSubtitle: '啟動或同步一个带專案路径的终端会话后，即可在这里預覽檔案。',
        searchPlaceholder: '搜索專案檔案...',
        searching: '正在搜索...',
        noFilesFound: '未找到檔案',
        tryDifferentTerm: '尝试不同的搜索词。',
        loadingProject: '正在載入專案...',
        unableToLoadProject: '無法加载專案',
        failedToLoadDirectory: '目錄載入失敗。',
        emptyProject: '專案为空',
        emptyProjectSubtitle: '此專案中没有找到檔案。',
        loadingFile: '正在載入檔案...',
        unableToPreviewFile: '無法預覽檔案',
        failedToReadFile: '讀取檔案失敗。',
        largeFile: '大檔案',
        largeFilePrompt: ({ fileName, size }: { fileName: string; size: string }) => `${fileName} 大小为 ${size}，預覽可能较慢。`,
        previewAnyway: '仍然預覽',
        previewUnavailable: '無法預覽',
        previewUnavailableSubtitle: '此檔案可以下載，或通过手機上的其他 App 開啟。',
        fileEmpty: '檔案为空。',
        downloaded: '已下載',
        downloadedMessage: ({ fileName }: { fileName: string }) => `${fileName} 已儲存到此设备。`,
        downloadFailed: '下載失败',
        openFailed: '開啟失败',
        copied: '已複製',
        copiedMessage: '檔案内容已複製到剪貼簿。',
        openDownloaded: '開啟已下載檔案',
        openFile: '開啟',
        online: '線上',
        offline: '離線',
    },
