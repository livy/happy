...
export const zhHans: TranslationStructure = {
    ...
    projects: {
        ...
        noProjectsSubtitle: '启动或同步一个带项目路径的终端会话后，即可在这里预览文件。',
        ...
        failedToLoadDirectory: '目录加载失败。',
        emptyProject: '项目为空',
        emptyProjectSubtitle: '此项目中没有找到文件。',
        loadingFile: '正在加载文件...',
        unableToPreviewFile: '无法预览文件',
        failedToReadFile: '读取文件失败。',
        largeFile: '大文件',
        largeFilePrompt: ({ fileName, size }: { fileName: string; size: string }) => `${fileName} 大小为 ${size}，预览可能较慢。`,
        previewAnyway: '仍然预览',
        previewUnavailable: '无法预览',
        previewUnavailableSubtitle: '此文件可以下载，或通过手机上的其他 App 打开。',
        fileEmpty: '文件为空。',
        downloaded: '已下载',
        downloadedMessage: ({ fileName }: { fileName: string }) => `${fileName} 已保存到此设备。`,
        downloadFailed: '下载失败',
        openFailed: '打开失败',
        copied: '已复制',
        copiedMessage: '文件内容已复制到剪贴板。',
        openDownloaded: '打开已下载文件',
        openFile: '打开',
        online: '在线',
        offline: '离线',
    },
    ...
    settingsVoice: {
        ...
        providerTitle: '语音模型',
        providerDescription: '选择麦克风使用的语音输入模型。ElevenLabs 保留完整语音对话体验；阿里百炼语音识别会录制一次发言，并把识别文本作为聊天消息发送。',
        provider: '输入模型',
        providerSubtitle: '点击麦克风时使用的模型',
        providerElevenLabs: 'ElevenLabs 对话',
        providerDashScopeAsr: '阿里百炼语音识别',
        dashScopeApiKey: 'DashScope API Key',
        dashScopeApiKeyDescription: '输入阿里云百炼 / DashScope API Key，用于百炼语音识别。将保存在同步的应用设置中。',
        dashScopeApiKeyPlaceholder: 'sk-...',
        dashScopeApiKeyConfigured: '已配置',
        dashScopeApiKeyNotSet: '未配置',
        language: {
