...
export const en = {
    ...
    projects: {
        ...
        noProjectsSubtitle: 'Start or sync a terminal session with a project path to preview files here.',
        ...
        emptyProjectSubtitle: 'No files were found in this project.',
        loadingFile: 'Loading file...',
        unableToPreviewFile: 'Unable to preview file',
        failedToReadFile: 'Failed to read file.',
        largeFile: 'Large file',
        largeFilePrompt: ({ fileName, size }: { fileName: string; size: string }) => `${fileName} is ${size}. Previewing large files may be slow.`,
        previewAnyway: 'Preview anyway',
        previewUnavailable: 'Preview unavailable',
        previewUnavailableSubtitle: 'This file can be downloaded or opened with another app on your device.',
        fileEmpty: 'File is empty.',
        downloaded: 'Downloaded',
        downloadedMessage: ({ fileName }: { fileName: string }) => `${fileName} saved to this device.`,
        downloadFailed: 'Download failed',
        openFailed: 'Open failed',
        copied: 'Copied',
        copiedMessage: 'File content copied to clipboard.',
        openDownloaded: 'Open downloaded',
        openFile: 'Open',
        online: 'Online',
        offline: 'Offline',
    },
    ...
    settingsVoice: {
        ...
        providerTitle: 'Voice Model',
        providerDescription: 'Choose the voice input model. ElevenLabs keeps the full voice conversation experience; Alibaba Bailian speech recognition records one utterance and sends the transcript as a chat message.',
        provider: 'Input Model',
        providerSubtitle: 'Model used when tapping the microphone',
        providerElevenLabs: 'ElevenLabs Conversation',
        providerDashScopeAsr: 'Alibaba Bailian ASR',
        dashScopeApiKey: 'DashScope API Key',
        dashScopeApiKeyDescription: 'Enter your Alibaba Cloud Model Studio / DashScope API key for Bailian speech recognition. Stored in synced app settings.',
        dashScopeApiKeyPlaceholder: 'sk-...',
        dashScopeApiKeyConfigured: 'Configured',
        dashScopeApiKeyNotSet: 'Not configured',
        language: {
