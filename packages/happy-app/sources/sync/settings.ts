...
export const SettingsSchema = z.object({
    ...
    voiceInputProvider: z.enum(['elevenlabs', 'dashscope-asr']).describe('Voice input provider'),
    voiceDashScopeApiKey: z.string().nullable().describe('DashScope API key for Bailian speech recognition'),
